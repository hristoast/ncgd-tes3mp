...
-- Stub in dependencies and external functions
DataManager = {}
DataManager.loadConfiguration = function()
   -- print("todo")
end

customEventHooks = {}
customEventHooks.registerValidator = function()
   -- print("TODO")
end
customEventHooks.registerHandler = function()
   -- print("TODO")
end
...
tes3mp = {}
tes3mp.LogMessage = function(level, msg)
   print(msg)
end

-- https://stackoverflow.com/a/9145447
package.path = '../main.lua;' .. package.path

local ncgd = require 'main'

-- BEGIN tests
ncgd.dbg("BEGIN tests")
